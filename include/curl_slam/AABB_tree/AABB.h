...
class Tree {
  public:
    ...
    /*! \param index
        ...
        \param fattenNum
            The fix fatten number for the bounding box
        ...
        \param upperBound
            The upper bound in each dimension.
     */
    void insertParticle(unsigned int, double, std::vector<double> &, std::vector<double> &);
    ...
    /*! \param index
        ...
        \param upperBound
            The upper bound in each dimension.
     */
    void insertGroundParticle(unsigned int, double,double, std::vector<double> &, std::vector<double> &);
